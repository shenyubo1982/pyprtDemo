...
def playDemo(filename):
    ...
    outputPath = '/tmp/pyprt_output/' + filename
    encoder_options = {'outputPath': outputPath}
    ...
    # PRT End
    # pyprt.shutdown_prt() # TODO: a new func to shutdown prt
    print('\nShutdown PRT.')
